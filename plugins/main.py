...
def process_message(data):
	...
	if 'tell a joke' in txt:
		...
		say(data, "Welcome newcomer! Here is a one-of-a-kind image we thought you might like. It's based on your personality as interpreted by an algorithm we have been developing over the last few months specifically for this. http://goo.gl/1fkHTt#" + str(randint(1,999999)))
